...
\begin{tabular}{ccc}
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		$x_{1,1,1}$ & $x_{1,1,2}$ & $\dots$ & $x_{1,1,W}$ \\
		\hline
		$x_{1,2,1}$ & $x_{1,2,2}$ & $\dots$ & $x_{1,2,W}$ \\
		\hline
		$\vdots$ & $\vdots$ & $\ddots$ & $\vdots$ \\
		\hline
		$x_{1,H,1}$ & $x_{1,H,2}$ & $\dots$ & $x_{1,H,W}$ \\
		\hline
	\end{tabular}
	&
	$\dots$
	...
	\begin{tabular}{|c|c|c|c|}
		\hline
		$x_{C,1,1}$ & $x_{C,1,2}$ & $\dots$ & $x_{C,1,W}$ \\
		\hline
		$x_{C,2,1}$ & $x_{C,2,2}$ & $\dots$ & $x_{C,2,W}$ \\
		\hline
		$\vdots$ & $\vdots$ & $\ddots$ & $\vdots$ \\
		\hline
		$x_{C,H,1}$ & $x_{C,H,2}$ & $\dots$ & $x_{C,H,W}$ \\
		\hline
	\end{tabular}
\end{tabular} ~\\
...
\begin{tabular}{ccc}
	...
	\begin{tabular}{|c|c|c|}
		\hline
		$z_{1,1,1}$ & $\dots$ & $z_{1,1,W_K}$ \\
		\hline
		$\vdots$ & $\ddots$ & $\vdots$ \\
		\hline
		$z_{1,H_K,1}$ & $\dots$ & $z_{1,H_K,W_K}$ \\
		\hline
	\end{tabular}
	&
	$\dots$
	...
	\begin{tabular}{|c|c|c|}
		\hline
		$z_{C,1,1}$ & $\dots$ & $z_{C,1,W_K}$ \\
		\hline
		$\vdots$ & $\ddots$ & $\vdots$ \\
		\hline
		$z_{C,H_K,1}$ & $\dots$ & $z_{C,H_K,W_K}$ \\
		\hline
	\end{tabular}
\end{tabular}
