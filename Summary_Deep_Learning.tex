...
\begin{itemize}
	\item Disable a random set of neurons (typically $50 \%$)
...
\begin{itemize}
	...
	\item Testing:
	\begin{itemize}
		\item Compute mean $\mu_{test}$ and variance $\sigma^2_{test}$ by running an exponentially weighted averages across training minibatches: \\
